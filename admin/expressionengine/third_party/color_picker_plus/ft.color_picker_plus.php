...
class Color_picker_plus_ft extends EE_Fieldtype {
	...
	function display_field($data)
	{
		...
		{
			$this->EE->cp->add_to_head('<link rel="stylesheet" media="screen" href="' . $this->theme_url . 'css/jPicker-1.1.6.min.css" />');
			$this->EE->cp->add_to_head('<link rel="stylesheet" media="screen" href="' . $this->theme_url . 'css/jPicker.css" />');
			...
			$this->EE->cp->add_to_foot('<script type="text/javascript" src="' . $this->theme_url . 'jpicker-1.1.6.min.js"></script>');
		...
		*/
		$imagesPath = $this->theme_url . 'images/';
	...
	function display_cell($data)
	{
    	...
    	if (!ee()->session->cache(__CLASS__, 'color_picker_assets_loaded'))
		{
			$this->EE->cp->add_to_head('<link rel="stylesheet" media="screen" href="' . $this->theme_url . 'css/jPicker-1.1.6.min.css" />');
			$this->EE->cp->add_to_head('<link rel="stylesheet" media="screen" href="' . $this->theme_url . 'css/jPicker.css" />');
			//$this->EE->cp->add_to_head('<script type="text/javascript" src="'.$this->EE->config->item('url_third_themes').'javascript/compressed/jquery/jquery.js"></script>');
			$this->EE->cp->add_to_foot('<script type="text/javascript" src="' . $this->theme_url . 'jpicker-1.1.6.min.js"></script>');
			ee()->session->set_cache(__CLASS__, 'color_picker_assets_loaded', TRUE);
		}
    ...
    function display_var_field($data)
    {
		...
		*/
		...
		$form = form_input (array(
			...
			'maxlength' => '8',
			'class'     => 'color_picker_plus',
			'style'     => 'width:60px; position: relative; height: 23px; margin-right: 4px; top: 5px;'
		));
	 ...
	 * @return bool
	 */
	function replacere_element_tag($data, $params = array(), $tagdata)
	{
