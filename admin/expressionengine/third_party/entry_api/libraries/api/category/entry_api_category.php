...
{	
    ...
    */
	 ...
	 * @return array            
	 */
	public function create_category($post_data = array())
	{
		/** ---------------------------------------
	 ...
	 * @return array            
	 */
	public function read_category($post_data = array())
	{
		/** ---------------------------------------
		/**  Validate data
		/** ---------------------------------------*/
		...
		{
			//generate error
			$this->service_error['error_category']['id'] = $post_data['cat_id'];
			return $this->service_error['error_category'];
		}
		...
		*/
		...
		$this->service_error['succes_read']['id'] = $post_data['cat_id'];
	 ...
	 * @return array            
	 */
	public function update_category($post_data = array())
	{
		/** ---------------------------------------
		/**  Validate data
		/** ---------------------------------------*/
		...
		*/
		...
		/** ---------------------------------*/	
		 ...
		 {
		 	//generate succes
		 	$this->service_error['succes_update']['id'] = $post_data['cat_id'];
			return $this->service_error['succes_update'];
		 }
		 else
		 {
		 	//generate succes
		 	$this->service_error['error_create_category']['id'] = $post_data['cat_id'];
			return $this->service_error['error_create_category'];
		 }	
	}
	 ...
	 * @return array            
	 */
	public function delete_category($post_data = array())
	{
		/** ---------------------------------------
		/**  Validate data
		/** ---------------------------------------*/
		...
		*/
		...
		$this->service_error['succes_delete']['id'] = $post_data['cat_id'];
