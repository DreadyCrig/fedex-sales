...
class Entry_api_category_group extends Entry_api_base_api
{	
	/*
	*	EE instance
	*/
	...
	*	Type of service
	*/
	public $api_type = 'category_group';
	 ...
	 * @return 	void
	 */
	public function create_category_group($auth = array(),  $post_data = array())
	{
		...
		if(ee()->db->insert('category_groups', $category_group) )
		{
			...
			*/
			...
			//if (ee()->extensions->active_hook('entry_api_create_category_group_end') === TRUE)
			//{
			//	ee()->extensions->call('entry_api_create_category_group_end', ee()->db->insert_id());
			//}
			// -------------------------------------------
	 ...
	 * @return 	void
	 */
	public function read_category_group($auth = array(), $post_data = array())
	{
		/** ---------------------------------------
		/**  Run some default checks
		/** ---------------------------------------*/
		...
		/*  - Added: 2.2
		*/
		Entry_api_helper::add_hook('read_category_group_end', $this->_get_category_group_by_id($post_data['group_id']));
		//if (ee()->extensions->active_hook('entry_api_read_category_group_end') === TRUE)
		//{
		//	ee()->extensions->call('entry_api_read_category_group_end', $this->_get_category_group_by_id($post_data['group_id']));
		//}
		// -------------------------------------------
		...
		/** return response
		/** ---------------------------------------*/
		$this->service_error['succes_read']['data'][0] = $this->_get_category_group_by_id($post_data['group_id']);
	 ...
	 * @return 	void
	 */
	public function update_category_group($auth = array(), $post_data = array())
	{
		/** ---------------------------------------
		/**  Run some default checks
		/** ---------------------------------------*/
		...
		else
		{
			...
			*/
			...
			//if (ee()->extensions->active_hook('entry_api_update_category_group_end') === TRUE)
			//{
			//	ee()->extensions->call('entry_api_update_category_group_end', $category_group_array);
			//}
			// -------------------------------------------
	 ...
	 * @return 	void
	 */
	public function delete_category_group($auth = array(), $post_data = array())
	{
		/** ---------------------------------------
		/**  Run some default checks
		/** ---------------------------------------*/
		...
		*/
		...
		//if (ee()->extensions->active_hook('entry_api_delete_category_group_end') === TRUE)
		//{
		//	ee()->extensions->call('entry_api_delete_category_group_end', '');
		//}
		// -------------------------------------------
