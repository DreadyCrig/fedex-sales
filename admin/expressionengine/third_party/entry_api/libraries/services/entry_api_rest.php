	...
	*/
    ...
    {        
        ...
        if(isset($api_settings->auth) && (bool) $api_settings->auth)
        {
            ...
            /** ---------------------------------------*/
            $default_checks = ee()->entry_api_base_api->default_checks($vars['auth'], $method, $site_id);
        ...
        //add a log
        ee()->entry_api_model->add_log(ee()->session->userdata('username'), $return_data, $method, 'rest', ee()->entry_api_base_api->servicedata);
    ...
    public function response($data = array(), $http_code = null)
    {
        ...
        if(ee()->entry_api_settings->item('rest_output_header') != '')
        {
            header(ee()->entry_api_settings->item('rest_output_header'));
        }
...
// 		
		// //set the header
		// if(ee()->uri->segment(4) == 'json' || ee()->uri->segment(4) == '')
		// {
			// header('Content-Type: application/json');
			// $response = json_encode($data);
		// }
		// else if(ee()->uri->segment(4) == 'xml') 
		// {
			// header('Content-Type: application/xml');
			// $response = assocArrayToXML('entry_api', $data);
		// }
		// else if(ee()->uri->segment(4) == 'php_array') 
		// {
...
/* End of file entry_api_rest.php */
/* Location: /system/expressionengine/third_party/entry_api/libraries/entry_api_rest.php */