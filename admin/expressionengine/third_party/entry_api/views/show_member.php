...
<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=entry_api'.AMP.'method=show_member'.AMP.'entry_api_id='.$entry_api_user->entry_api_id, '', $hidden)?>
...
//build the checkbox
$services = '';
$services_selected = explode('|',$entry_api_user->services);
...
$api = '';
$apis_selected = explode('|',$entry_api_user->apis);
...
// $free_api = '';
// $free_apis_selected = explode('|',$entry_api_user->free_apis);
...
$this->table->add_row(lang('active','active'), form_dropdown( 'active', $active, $entry_api_user->active));
$this->table->add_row(lang('log', 'log'), form_dropdown( 'logging', $logging, $entry_api_user->logging));
$this->table->add_row(lang('Api Keys', 'api_keys'), form_textarea( 'api_keys', ($entry_api_user->api_keys)));
