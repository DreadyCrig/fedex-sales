...
<p>
	...
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_channel_create" class="less_important_bttn">Create Channel</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_channel_read" class="less_important_bttn">Read Channel</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_channel_update" class="less_important_bttn">Update Channel</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_channel_delete" class="less_important_bttn">Delete Channel</a></span>
	<div class="clear"></div>
</p>
