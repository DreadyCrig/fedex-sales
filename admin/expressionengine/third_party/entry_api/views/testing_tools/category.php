...
<p>
	...
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_create" class="less_important_bttn">Create Category</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_read" class="less_important_bttn">Read Category</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_update" class="less_important_bttn">Update Category</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_delete" class="less_important_bttn">Delete Category</a></span>
	<div class="clear"></div>
</p>
