...
<p>
	...
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_group_create" class="less_important_bttn">Create Category Group</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_group_read" class="less_important_bttn">Read Category Group</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_group_update" class="less_important_bttn">Update Category Group</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_category_group_delete" class="less_important_bttn">Delete Category Group</a></span>
	<div class="clear"></div>
</p>
		...
		<div>
			...
			<?php
				...
				foreach ($fields['data'] as $key => $val)
				{
					...
					if($key == 'rest_http_auth') {continue;}
					//subtext
					$subtext = '';
					if(is_array($val))
					{
