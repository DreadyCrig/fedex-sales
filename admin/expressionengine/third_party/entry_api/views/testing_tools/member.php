...
<p>
	...
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_member_create" class="less_important_bttn">Create Member</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_member_read" class="less_important_bttn">Read Member</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_member_update" class="less_important_bttn">Update Member</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_member_delete" class="less_important_bttn">Delete Member</a></span>
	<div class="clear"></div>
</p>
