...
<p>
	...
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_comment_create" class="less_important_bttn">Create Comment</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_comment_read" class="less_important_bttn">Read Comment</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_comment_update" class="less_important_bttn">Update Comment</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_comment_delete" class="less_important_bttn">Delete Comment</a></span>
	<span class="button" style="float:right;"><a id="new-channel" href="<?=$base_url?>method=testing_tools_comment_search" class="less_important_bttn">Search Comment</a></span>
	<div class="clear"></div>
</p>
