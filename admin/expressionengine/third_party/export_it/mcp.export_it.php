...
class Export_it_mcp 
{
	...
	public function __construct()
	{
		...
		$this->EE->cp->add_to_foot('<link type="text/css" rel="stylesheet" href="'.$this->EE->config->config['theme_folder_url'].'/third_party/export_it/css/export_it.css" />');
	...
	public function settings()
	{
		...
		{
			$this->EE->cp->add_to_foot('<link type="text/css" rel="stylesheet" href="'.$this->EE->config->config['theme_folder_url'].'/third_party/export_it/css/accordion.css" />');
		}
